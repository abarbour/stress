...
%                                                                         %
%*************************************************************************%
function plot_stress_axes(sigma_vector_1_,sigma_vector_2_,sigma_vector_3_,plot_file)
...
%--------------------------------------------------------------------------
h = figure; hold on; title('Confidence of principal stress axes                 ','FontSize',16);
axis off; axis equal; axis([-1.05 1.70 -1.05 1.05]);

%--------------------------------------------------------------------------
% plotting the stress directions
plot(y_sigma_1,x_sigma_1,'r.','MarkerSize',20,'LineWidth',1.5);	% sigma_1
plot(y_sigma_2,x_sigma_2,'g.','MarkerSize',20,'LineWidth',1.5);	% sigma_2
plot(y_sigma_3,x_sigma_3,'b.','MarkerSize',20,'LineWidth',1.5);	% sigma_3
